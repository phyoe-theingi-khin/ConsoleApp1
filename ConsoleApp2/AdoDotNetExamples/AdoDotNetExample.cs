...
namespace PTKDotNetCore.ConsoleApp.AdoDotNetExamples;
...
public class AdoDotNetExample
{
    public void Read()
    {
        ...
        sqlConnectionStringBuilder.DataSource = "DESKTOP-4FNB1J3\\MSSQLSERVER1";
        sqlConnectionStringBuilder.InitialCatalog = "TestDb";
        sqlConnectionStringBuilder.UserID = "sa";
        sqlConnectionStringBuilder.Password = "phyo@123";
